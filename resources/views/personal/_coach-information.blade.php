    ...
    <form action="" class="has-success">
      ...
      <div>
        ...
        <p><span>描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。</span>
          <textarea class="form-control hidden edit" rows="4">描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。描述。。</textarea>
        </p>
...
@section('js')
  <script src="/vendor/tencent_cloud_sdk/sdk/qcloud_sdk.js"></script>
  <script src="/vendor/tencent_cloud_sdk/sdk/swfobject.js"></script>
  <script>
